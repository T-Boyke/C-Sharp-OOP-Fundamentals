...
| [15](./15_Klausur) | **Klausur (Probe)** | Observer Pattern, OOP Review | ✅ |
...
```
## Aktueller Stand: 28. Januar 2026

Das Repository wurde um das Modul 21 erweitert. Dieses beinhaltet:
...
## Projekt-Struktur
Jedes Modul enthält:
1. Eine spezifische `README.md` mit Lernzielen und Aufgabenstellung.
2. Das entsprechende Referenzmaterial (PDF-Folien oder Aufgabenblätter).
3. Ein C#-Projekt für die Implementierung.
4. Ein Test-Projekt zur Validierung der Funktionalität.

## Richtlinien
* **Dokumentation**: Durchgängige Nutzung von XML-Dokumentationskommentaren.
* **Qualität**: Code-Lösungen folgen den erweiterten IHK-Vorgaben für Fachinformatiker.
* **Entwicklung**: Einsatz von Test-Driven Development (TDD) und Separation of Concerns (SFC).
---

<div align="center">
    <sub>Built with ❤️ by t-boyke for .NET Developers</sub>
</div>
